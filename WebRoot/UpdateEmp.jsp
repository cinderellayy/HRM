	...
	<script type="text/javascript">
			...
			function checkForm() {				
				...
				if (empName.value == '' || empName.value.length>6) {
					alert('Employee name cannot be empty and up to 6 characters');
					empName.focus();
					return false;
				}
				...
				if (empEmail.value == '' || empEmail.value.length>30) {
					alert('Email address cannot be empty and up to 30 characters');
					empEmail.focus();
					return false;
				}
...
<body class="container">
	<div class="panel panel-default ">
		...
		<form name="form1" class="form-group" method="post" action="UpdateEmpServlet" onsubmit="return checkForm();">
			<table class="table_border table" >

				<tr>
					<td >Employee name</td>
					<td >
						<input class="form-control" name="empName" type="text" id="empName" value="${emp.empName}"></td>
				</tr>
				<tr>
					<td>Email</td>
					<td>
						<input class="form-control"name="empEmail" type="text" id="empEmail" value="${emp.empEmail}"></td>
				</tr>
				<tr>
					<td>Telephone number</td>
					<td >
						<input class="form-control"  name="empPhone" type="text" id="empPhone"  value="${emp.empPhone}"></td>
				</tr>
				<tr>
					<td>Date of entry</td>
					<td >
						<input class="form-control" name="empHiredate" type="text" id="empHiredate" onclick="WdatePicker()" value="${emp.empHiredate}" ></tr>
					<tr>
						<td>Position</td>
						...
						<td>
							...
							-
							<input style = "width:50px" name="jobMaxSalary" type="text" id="jobMaxSalary"></td>
					</tr>

					<tr>
						<td >Salary</td>
						<td>
							<input class="form-control" name="empSalary" type="text" id="empSalary"></td>
					</tr>
					<tr>
						<td>Department</td>
						<td>
					...
					<tr align="center">
						<td height="24" colspan="2">
							...
							<input  class="btn" type="button" name="Submit2" value="CANAEL" onclick="history.back();"></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<p class="pull-right">
		<a href="#"> <i class="glyphicon glyphicon-plane"></i>
		</a>
	</p>
</div>
</body>
