		...
		<div class="stage">
			...
			<div class="section-divider-a m-hide container">
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading" >Position query</div>

					<form name="form1" method="post" action="UpdateJobServlet">
						<table class="table table-hover" >
						<thead>
							<tr>
								<td width="20%">Position number</td>
								<td width="20%">Position name</td>
								<td width="20%">The lowest salary</td>
								<td width="20%">The highest salary</td>
								<td width="20%">Operation</td>
							</tr>
							</thead>
							<c:forEach items="${list}" var="job">
								<tr>
									<td class="table-bordered">${job.jobId }</td>
									<td class="table-bordered">${job.jobName }</td>
									<td class="table-bordered">${job.jobMinSalary }</td>
									<td class="table-bordered">${job.jobMaxSalary }</td>

									<td class="table-bordered" align="center">
										<a  onclick="updateJob('${job.jobId}','${adminLevel}')">
											<img src="./img/edit.png"></a>
										&nbsp &nbsp &nbsp
										<a  onclick="deleteJob('${job.jobId}','${adminLevel}')">
					...
					<table  class="table table_bordered">
						<thead>
							<tr>
								<td align="center">
									<a  class="color" onclick="InsertJob('${adminLevel}')">Add new positions</a>
								</td>
							</tr>
						</thead>
					</table>
