...
<div class="panel panel-default ">
	...
	<div class="panel-heading">Department of query</div>
	<table cellpadding="4" class="table-hover table " width="60%" border="0" >
	<tbody>
	<thead>
		<tr>
			<th width="25%" height="24">Department number</th>
			<th width="25%" height="24">Department name</th>
			<th width="25%" height="24">Department address</th>
			<th width="25%" height="24">Operation</th>
		</tr>
</thead>
		<c:forEach items="${list}" var="dept">
			<tr >
				<td class="table-bordered" height="24">${dept.deptId }</td>
				<td class="table-bordered" height="24">${dept.deptName }</td>
				<td  class="table-bordered"height="24">${dept.deptLoc }</td>
				<td  class="table-bordered" height="24">
					<a onclick="updateDept('${dept.deptId}','${adminLevel}')"><img src="./img/edit.png"></a> &nbsp &nbsp &nbsp
					<a onclick="deleteDept('${dept.deptId}','${adminLevel}')"><img src="./img/delete.png"></a>
				</td>
			</tr>
    ...
    <thead>
    <tr>
       <td align="center"><a onclick="InsertDept('${adminLevel}')" class="color">Add new departments</a></td>
    </tr>
    </thead>
</table>
